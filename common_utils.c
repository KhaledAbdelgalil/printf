	...
	get_handleFunc_to_exec(c_char *formattedString, int idx)
{
	...
	{"b", handle_binary}, {"x", handle_hexaSmall}, {"X", handle_hexaCapital},
	{"o", handle_oct}, {"r", handle_rev_str}, {"l", handle_percentage},
	{"h", handle_percentage}, {"u", handle_uint}, {"S", handle_special_str},
	{"p", handle_address}, {"+x", handle_hexaSmall}, {"+X", handle_hexaCapital},
	{"+o", handle_oct}, {"li", handle_long_int}, {"ld", handle_long_int},
	{"hx", handle_short_hexaSmall}, {"hi", handle_short_int},
	{"hd", handle_short_int},
	{"hX", handle_short_hexaCapital}, {"lx", handle_long_hexaSmall},
	{"lX", handle_long_hexaCapital},
	{"lu", handle_long_uint}, {"S", handle_special_str}, {"+x", handle_hexaSmall},
	{"hu", handle_short_uint}, {"+X", handle_hexaCapital}, {"+o", handle_oct},
	{"ho", handle_short_oct}, {" X", handle_hexaCapital},
	{" x", handle_hexaSmall},
	{"lo", handle_long_oct}, {"+i", handle_plus_int}, {"+d", handle_plus_int},
	{" i", handle_space_int}, {" d", handle_space_int},
	{"#x", handle_hexaSmall_hashtag},
	{"#X", handle_hexaCapital_hashtag}, {"#d", handle_int}, {"#i", handle_int},
	{"#o", handle_oct_hashtag},
	{" o", handle_oct}, {"+u", handle_uint}, {"#u", handle_uint},
	{" u", handle_uint}, {" +i", handle_plus_int}, {" +d", handle_plus_int},
